...
Command: npx gltfjsx@6.2.14 public/models/Ninja.gltf -o src/components/Ninjia.jsx -r public 
*/

import React, { useRef, useEffect } from 'react';
import { useGLTF, useAnimations } from '@react-three/drei';

export default function Ninja({ hovered, ...props }) {
  const group = useRef();
  ...
  useEffect(() => {
    const anim = hovered ? "Weapon" : "Duck";
